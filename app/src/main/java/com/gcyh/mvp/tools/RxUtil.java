package com.gcyh.mvp.tools;

import android.graphics.Bitmap;
import android.graphics.BitmapFactory;

import com.gcyh.mvp.app.App;
...
public class RxUtil {
    ...
    public static  Observable.Transformer<com.gcyh.mvp.http.response.HttpResponse, com.gcyh.mvp.http.response.HttpResponse> handleResultHttpResponse() {   //compose判断结果
        return new Observable.Transformer<com.gcyh.mvp.http.response.HttpResponse, com.gcyh.mvp.http.response.HttpResponse>() {
            @Override
            public Observable<com.gcyh.mvp.http.response.HttpResponse> call(Observable<HttpResponse> httpResponseObservable) {
                return httpResponseObservable.flatMap(new Func1<com.gcyh.mvp.http.response.HttpResponse, Observable<com.gcyh.mvp.http.response.HttpResponse>>() {
                    @Override
                    public Observable<com.gcyh.mvp.http.response.HttpResponse> call(com.gcyh.mvp.http.response.HttpResponse tHttpResponse) {
                        int code = tHttpResponse.getCode();
                        if (code==Constant.HTTP_STATUS_FORCE_LOGIN){
                            App.getInstance().forceLogin();
                            return null;
